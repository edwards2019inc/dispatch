...
function Itinerary(){
  ...
  */
  ...
  this.addStop = function(destination, constraints={}){
    ...
    this.wait_service_times_before.push(constraints.wait_service_before);
    this.wait_service_times_after.push(constraints.wait_service_after);
    if(this.stops.length > 1){
...
function Ride(){
  ...
  this.id = -1;
  this.passenger = "";
  this.one_way = constants.ONE_WAY;
